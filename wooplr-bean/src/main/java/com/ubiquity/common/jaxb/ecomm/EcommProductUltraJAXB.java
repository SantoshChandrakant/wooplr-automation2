...
@XmlType(name = "EcommProductLimitedJAXB", propOrder = { "id", "name", "storeName", "storeId", "price", "discount",
		"stock", "image_pid", "available", "salesPrice", "webLink", "manufacture", "isEcommSupported", "isNew",
		"category", "subcategory", "subcategory2"

})
@XmlRootElement
public class EcommProductUltraJAXB implements Serializable, Countable {
	...
	public static enum FIELDS {
		ID("ID"), NAME("NAME"), STORE_NAME("STORE_NAME"), STORE_ID("STORE_ID"), PRICE("PRICE"), DISCOUNT(
				"DISCOUNT"), STOCK("STOCK"), IMAGE_PID("IMAGE_PID"), AVAILABLE("AVAILABLE"), SALES_PRICE(
						"SALES_PRICE"), WEB_LINK("WEB_LINK"), MANUFACTURE("MANUFACTURE"), IS_ECOMM_SUPPORTED(
								"IS_ECOMM_SUPPORTED"), CATEGORY(
										"CATEGORY"), SUBCATEGORY("SUBCATEGORY"), SUBCATEGORY2("SUBCATEGORY2");
	...
	public String toString() {
		return "EcommProductLimitedJAXB{" + "id=" + id + ", name='" + name + '\'' + ", storeName='" + storeName + '\''
				...
				// ", size='" + size + '\'' +
				", isEcommSupported=" + isEcommSupported +
				// ", sequenceInCollection=" + sequenceInCollection +
				", category='" + category + '\'' + ", subcategory='" + subcategory + '\'' + ", subcategory2='"
				+ subcategory2 + '\'' +
	...
	public boolean equals(Object o) {
		...
		EcommProductUltraJAXB that = (EcommProductUltraJAXB) o;
